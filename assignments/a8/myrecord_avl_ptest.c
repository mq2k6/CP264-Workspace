...
RECORD testsA[] = {{"A01", 10}, {"A02", 20}, {"A03", 30}, {"A04", 40}, {"A05", 50}, {"A06", 60}, {"A07", 70}, {"A08", 80}, {"A09", 90}, {"A10", 100}};

RECORD testsB[] = {{"B01", 10}, {"B02", 20}, {"B03", 30}, {"B04", 40}, {"B05", 50}, {"B06", 60}, {"B07", 70}, {"B08", 80}, {"B09", 90}, {"B10", 100}};
...
void test_avlds_merge()
{
	...
	printf("[%f %f]", avldsA.stddev, avldsC.stddev);
